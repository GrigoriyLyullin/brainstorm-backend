...
//
//        Idea idea = ideaRepository.save(new Idea(testTitle, testDescription, new Category(ObjectId.get(), testCategory), voters));
//
//        assertNotNull(idea.getId());
//        assertEquals(testTitle, idea.getTitle());
//        assertEquals(testDescription, idea.getDescription());
////        assertEquals(testCategory, idea.getCategory().get(0).getCategory());
